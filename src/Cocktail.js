...
const CocktailList = props => {
    return (
        <div>
            ...
            <ul>
                {props.cocktails.map((currCocktail) => SingleCocktail(currCocktail, props))}
            </ul>
        </div>
    )
}
...
const SingleCocktail = (cocktail, props) => {
    ...
    return (
        <li>
            ...
            <button className="saveCocktail" type="button" onClick={() => props.saveCocktail(cocktail, cocktailIngredients)}>Save this drink</button>
        </li>
    )
}
